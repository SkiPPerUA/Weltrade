...
public class SessionTestNGTest extends Assert
{
    ...
    public void smokeTest() {
       ...
       // assertFalse(mainPageLogged.mainMenu.regLink.isExist(0), "Login link is exist after login");
       // assertTrue(mainPageLogged.mainMenu.profile.isExist(0), "Logout link is not exist after login");
       // assertTrue(mainPageLogged.mainMenu.privateMessages.isExist(0), "Logout link is not exist after login");
       // assertTrue(mainPageLogged.mainMenu.logout.isExist(0), "Logout link is not exist after login");
       // assertTrue(mainPageLogged.mainMenu.users.isExist(0), "Logout link is not exist after login");
