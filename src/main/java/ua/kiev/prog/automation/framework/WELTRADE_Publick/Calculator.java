...
public class Calculator extends PageObject {
    ...
    private final GUIButton typeAccount = new GUIButton(Locator.create("/html/body/section/section/div[2]/div[1]/div/form[1]/div[1]/div/button"));
    ...
    final public GUIButton buttonReset = new GUIButton(Locator.create("/html/body/section/section/div[2]/div[1]/div/form[2]/div[3]/button"));
    ...
    public final GUITextBox spreadValue = new GUITextBox(Locator.create("/html/body/section/section/div[2]/div[2]/div/div/div[3]/div[2]/p[1]"));


    public void culculateForex (String acc, String tool, String lot, String leverages){

        typeAccount.click();
        GUIButton account = new GUIButton(Locator.create(".//div/div/ul/li/a/span[contains(text(), '"+acc+"')]"));
        account.click();
