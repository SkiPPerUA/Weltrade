...
public class CashierFinOperation1 extends PageObject {
    ...
    final public GUITextBox summDeposit = new GUITextBox(Locator.create(".//div[5]/div[2]/input[@type='text']"));
    ...
    public final GUITextBox summWithdrawal = new GUITextBox(Locator.create("/html/body/app-root/app-pages/main/app-operations/section/div/app-operations-withdrawal/div/div[1]/div/div/div[1]/div/div[5]/div[2]/input"));


    final public GUIButton createInvoiceButton = new GUIButton(Locator.create(".//button[contains(@class,'wt-btn blue')]"));
    ...
    public void setPaySystemDeposit(String sys) throws InterruptedException {
    ...
    public void setPayCurrencyDeposit(String cr) throws InterruptedException {
    ...
    public void setTargetAccountDeposit(String acc){
        targetAccountDeposit.click();
        WebElement a = Session.get().driver().findElement(By.xpath(".//mat-option/span[contains(text(), '"+acc+"')]/.."));
        a.click();
    }

    public void setTargetAccountWithdrawal(String acc){
        targetAccountWithdrawal.click();
        WebElement a = Session.get().driver().findElement(By.xpath(".//mat-option/span[contains(text(), '"+acc+"')]/.."));
        a.click();
    }

    public void setPaySystemWithdrawal(String sys){
        paySystemWithdrawal.click();
        WebElement a = Session.get().driver().findElement(By.xpath(".//span[contains(text(), '"+sys+"')]"));
        a.click();
    }

    public void setWalletWithdrawal(String wall){
